...
class ASformer(nn.Module):
    def __init__(self, num_classes, num_decoders=3, num_layers=5, r1=2, r2=2, num_f_maps=64, input_dim=12, channel_masking_rate=0.1):
        super(ASformer, self).__init__()
        self.encoder = Encoder(num_layers, r1, r2, num_f_maps, input_dim, num_classes, channel_masking_rate,
                               att_type='normal_att', alpha=1) #sliding_att
        self.decoders = nn.ModuleList([copy.deepcopy(
            Decoder(num_layers, r1, r2, num_f_maps, num_classes, num_classes, att_type='normal_att', #sliding_att
